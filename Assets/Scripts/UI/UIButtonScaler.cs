...
public class UIButtonScaler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        IsExit = true;
        scaleTween.Complete();
        scaleTween = Tween.Scale(transform, initialScale, recoverDuration, Ease.Linear);
    }
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        if (isUp && IsDown && IsExit)
        {
            ...
            {
                scaleTween = Tween.Scale(transform, calculatedTargetScale, scaleDuration, Ease.Linear);
            }
        }
    }
